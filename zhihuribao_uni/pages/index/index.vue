	...
	<view style="height: auto;width: 100%;display: inline-block;">
		<view style="height: auto;width: 100%;">
			<swiper style="width: 100%;" :indicator-dots="true" :autoplay="true" :interval="3000" :duration="1000">
				<swiper-item v-for="(item,index) in title_content" :key="index" @tap="detail" :data-newsid="item.id" >
		...
		<view class="content">
			<view class="uni-list">
				...
				@tap="detail_a" :data-news_id="item.news_id" >
		...
		methods: {
			...
			detail_a(e){
				uni.navigateTo({
					...
					url:"../info/new_file?id="+e.currentTarget.dataset.news_id
				})
			}
		},
		onLoad() {
